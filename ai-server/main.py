from fastapi import FastAPI, WebSocket, WebSocketDisconnect  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports]
from fastapi.responses import PlainTextResponse  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports]
from langchain_core.output_parsers import StrOutputParser
from langchain_core.prompts import ChatPromptTemplate, MessagesPlaceholder
from langchain_core.runnables.history import RunnableWithMessageHistory
from langchain_community.chat_message_histories.redis import RedisChatMessageHistory  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports]
from langchain.chat_models import init_chat_model
from dotenv import load_dotenv  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports]
import uvicorn  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports]
import os
...
if not base_url:
    raise EnvironmentError("Please set DEEPSEEK_BASE_URL.")
